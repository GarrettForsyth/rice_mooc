...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        /**
         * Threshold value to run in parallel
         */
        private int SEQUENTIAL_THRESHOLD = 10000;
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        ArrayList<ReciprocalArraySumTask> listOfTasks =
                new ArrayList<>();
        ...
        for (ReciprocalArraySumTask t : listOfTasks){
            sum += t.getValue();
        }
